        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompactTables = table.Column<bool>(type: "boolean", nullable: false),
                    ThemeColor = table.Column<string>(type: "text", nullable: false),
                    LowStockAlerts = table.Column<bool>(type: "boolean", nullable: false),
                    ExpenseAlerts = table.Column<bool>(type: "boolean", nullable: false),
                    PopupNotifications = table.Column<bool>(type: "boolean", nullable: false),
                    PinLock = table.Column<bool>(type: "boolean", nullable: false),
                    PinCode = table.Column<string>(type: "text", nullable: true),
                    RequirePinOnLogin = table.Column<bool>(type: "boolean", nullable: false),
                    AutoLogout = table.Column<string>(type: "text", nullable: false),
                    AutoPrintReceipt = table.Column<bool>(type: "boolean", nullable: false),
                    ConfirmBeforeSale = table.Column<bool>(type: "boolean", nullable: false),
                    AllowDiscounts = table.Column<bool>(type: "boolean", nullable: false),
                    MonthlyExpenseLimit = table.Column<decimal>(type: "numeric(18,2)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RestockReports", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    RestockReportId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RestockItems_RestockReports_RestockReportId",
                        column: x => x.RestockReportId,
                        principalTable: "RestockReports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestockItems_RestockReportId",
                table: "RestockItems",
                column: "RestockReportId");
